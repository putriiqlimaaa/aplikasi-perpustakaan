class Buku {
  ...
  Buku({required this.judul, required this.pengarang, required this.penerbit, required this.imageUrl, required this.category, required this.tahun_terbit, required this.sinopsis});
}
...
List<Buku> bukuList = [
  ...
  Buku(
    ...
    tahun_terbit: '2023',
    sinopsis: 'Bahasa Inggris susah? Siapa bilang! Bahasa Inggris justru adalah bahasa paling mudah dipelajari karena susunan katanya begitu sederhana dan nggak jauh beda dengan susunan kata bahasa Indonesia. Tapi, pertama-tama, kamu mesti kenal grammarnya dulu. Praktis, mudah, nggak ribet. Bawa buku ini ke mana pun kamu pergi, kenali dan pahami setiap kosakata dan frasanya, dijamin sebentar lagi kamu akan cas-cis-cus ngomong pakai bahasa Inggris.',
    category: 'Pelajaran',
  ),
  Buku(
    ...
    tahun_terbit: '2023',
    sinopsis: 'Problem Based Learning merupakan metode pembelajaran berdasarkan pada prinsip penanganan kasus sebagai titik pangkal untuk mendapatkan dan mengintegrasikan ilmu pengetahuan yang baru. Pengertian lain tentang Problem Based Learning merupakan metode pembelajaran yang mana peserta didik diberikan permasalahan shari hari yang kompleks dan tidak memilikisatu jawaban yang benar. Hadirnya buku Problem Based Learning menjadi salah satu cara yang dapat digunakan oleh para pendidik dalam usaha membantu peserta didik agar menjadi kompeten dalam memecahkan masalah dan menghadapi tantangan ke depan.',
    category: 'Pelajaran',
  ),
  Buku(
  ...
  Buku(
    ...
    tahun_terbit: '2024',
    sinopsis: 'Buku Pendidikan Jasmani, Olahraga, dan Kesehatan Berbasis Profil Pelajar Pancasila SMP/MTs Kelas 8 ini disusun dengan menggunakan Kurikulum Merdeka yang mengusung semangat merdeka belajar. Adapun kebijakan pengembangan kurikulum ini tertuang dalam Keputusan Kepala Badan Standar, Kurikulum, dan Asesmen Pendidikan Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi Nomor 033/H/KR/2022 Hasil Uji Publik tentang Capaian Pembelajaran pada Pendidikan Anak Usia Dini, Jenjang Pendidikan Dasar, dan Jenjang Pendidikan Menengah pada Kurikulum Merdeka. Untuk mendukung pelaksanaan kurikulum tersebut, diperlukan penyediaan buku teks pelajaran yang sesuai dengan kebutuhan. Buku teks pelajaran ini merupakan salah satu bahan pembelajaran bagi siswa dan guru.',
    category: 'Pelajaran',
  ),
  Buku(
    ...
    tahun_terbit: '2023',
    sinopsis: ': Bisnis yang bersinggungan erat dengan kehidupan masyarakat dan berdampak pada kesejahteraan masyarakat dan ekonomi terus berkembang dipacu dengan adanya kemajuan teknologi dan ilmu pengetahuan. Dalam memulai sebuah bisnis, ada pertanyaan-pertanyaan yang turut menyertai.',
    category: 'Pelajaran',
  ),
  Buku(
    ...
    tahun_terbit: '2022',
    sinopsis: 'DENGAN BERBASIS PADA REFLEKSI ATAS PENGALAMAN YANG PERNAH PENULIS ALAMI DAN JUGA BERDASARKAN BACAAN PENULIS ATAS SEJUMLAH REFERENSI YANG ADA, KEMUDIAN MENYADARI PENTINGNYA SEBUAH BUKU PANDUAN.',
    category: 'Pelajaran',
  ),
  ...
  Buku(
    ...
    tahun_terbit: '2009',
    sinopsis: 'Alif lahir di pinggir Danau Maninjau dan tidak pernah menginjak tanah di luar ranah Minangkabau. Masa kecilnya adalah berburu durian runtuh di rimba Bukit Barisan, bermain bola di sawah berlumpur dan tentu mandi berkecipak di air biru Danau Maninjau. Tiba-tiba saja dia harus naik bus tiga hari tiga malam melintasi punggung Sumatera dan Jawa menuju sebuah desa di pelosok Jawa Timur. Ibunya ingin dia menjadi Buya Hamka walau Alif ingin menjadi Habibie. Dengan setengah hati dia mengikuti perintah Ibunya: belajar di pondok.',
    category: 'Novel',
  ),
  Buku(
  ...
  Buku(
    ...
    tahun_terbit: '2023',
    sinopsis: 'Klub MATCHA pergi ke Paris! Yeay! Mereka menginap di hotel besar dan mewah, makan siang sambil belajar memasak bersama chef internasional, dan yang paling seru adalah mereka naik ke puncak Menara Eiffel! Wah, keseruan apa lagi yang akan mereka temui selama berada di Paris?',
    category: 'Cerita Anak',
  ),
  Buku(
  ...
  Buku(
    ...
    tahun_terbit: '2023',
    sinopsis: 'Pernahkah kamu merasa sedih? Kenapa ya, sedih bisa terjadi? Apa yang harus dilakukan supaya rasa sedih berkurang dan hilang? Kemudian, apa yang bisa kita lakukan kalau melihat teman sedang sedih? Yuk, temukan rahasia tentang "Sedih" di dalam buku ini!',
    category: 'Cerita Anak',
  ),
  ...
  //sejarah
   ...
   Buku(
    ...
    tahun_terbit: '2022',
    sinopsis: 'Berbicara Majapahit, kita langsung terkenang akan kebesaran peradaban yang pernah dicapai oleh kerajaan ini. Pun, seorang patih yang masyhur dengan Sumpah Palapa-nya. Maha Patih yang menyatukan kekuasaan Majapahit dalam satu rumpun Nusantara. Hingga kini, sisa-sisa kebesaran akan Kerajaan Majapahit masih dapat disaksikan keberadaannya melalui temuan-temuan arkeologis yang berserakan di berbagai tempat di Nusantara. Namun, sepeninggal Hayam Wuruk dan Gajah Mada, kerajaan ini dipenuhi perang saudara dan kudeta perebutan kekuasaan. Perang saudara dan gerak-gerak kudeta yang begitu panjang dan melelahkan itu pada akhirnya melemahkan kekuatan Majapahit hingga menyebabkan keruntuhannya.',
    category: 'Sejarah',
   ),
   Buku(
  ...
  Buku(
   ...
   Buku(
    ...
    tahun_terbit: '2023',
    sinopsis: ': Shalat menempati posisi strategis dalam peta keimanan seorang Muslim. Namun, ternyata tak sedikit di antara kita yang masih melakukan kesalahan dalam doá dan gerakan shalat. Kesalahan pembelajaran di masa kecil dan keengganan mencari tahu kebenaran tata cara shalat ini menjadi sebuah kombinasi sempurna tentang kebutaan kita akan pelaksanaan shalat yang sesuai dengan tuntunan Rasulullah .',
    category: 'Agama',
   ),
   Buku(
    ...
    tahun_terbit: '2024',
    sinopsis: 'Berfilsafat adalah aktivitas yang tidak dapat dielakkan oleh siapa pun. Hal itu merupakan aktivitas normal setiap orang, termasuk orang-orang Kristen yang sudah dewasa. Orang Kristen sering harus berfilsafat. Meskipun demikian, ada hal unik tentang bagaimana seharusnya mereka melakukannya.',
    category: 'Agama',
   ),
   Buku(
   ...
   Buku(
    ...
    tahun_terbit: '2017',
    sinopsis: 'Brahmā adalah raja surgawi dalam agama Buddha. Dia diambil dari agama-agama India lainnya seperti Hinduisme yang menganggapnya sebagai pelindung ajaran (dharmapala), dan tidak pernah diceritakan dalam kitab-kitab Buddha awal sebagai dewa pencipta.',
    category: 'Agama',
   ),
   Buku(
   ...
   Buku(
    ...
    tahun_terbit: '2024',
    sinopsis: 'Kehadiran sains dan teknologi kerap membuat kita merasa mampu menjawab segalanya, termasuk perkara Tuhan. Ketika kemudian agama dianggap bertentangan dengan ilmu pengetahuan, berbagai narasi ateisme baru pun bermunculan. Di sisi lain, orang-orang beriman justru merasa bahwa agama tidak membutuhkan logika, hanya keyakinan belaka. Padahal, jauh-jauh hari Imam Sanusi (1426–1490 M ) melalui karyanya, Ummul Barahin, justru menjelaskan bahwa beriman adalah perkara yang rasional. Ahmad Ataka dalam buku Logika Keimanan ini mengajak kita untuk mengungkap rasionalitas aqidah Imam Sanusi berdasarkan analogi sains dan teknologi masa kini',
    category: 'Agama',
   ),
   Buku(
    ...
    tahun_terbit: '2021',
    sinopsis: 'Setiap manusia, pasti pernah mengalami keadaan jauh dari Sang Pencipta. Hal ini yang membuat setiap manusia enggan untuk kembali kepada-Nya. Dengan alasan, Sudah terlanjur jauh! atau Sudah banyak dosa! Padahal, Allah hanya ingin kita terus mengingat-Nya. Semata, karena Allah ingin kita menjadi hamba yang selalu membutuhkan-Nya. Hadirnya buku ini, penulis hanya ingin agar kita selalu bersama Allah, di mana hanya dekat dengan Allah-lah yang membuat hidup kita tenang, senang, nyaman, dan bahagia. Selain itu, buku ini juga ingin mengajak kita untuk mensyukuri setiap nikmat-Nya. Di buku ini, kita juga diajak agar selalu bersyukur menjadi seorang wanita, yang kehormatannya sangat dijaga, dimuliakan bahkan dihargai.',
    category: 'Agama',
   ),
